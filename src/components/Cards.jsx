    ...
    <div className='bg-white w-full py-[10rem] px-4'>
        <div className='grid md:grid-cols-3 gap-8 max-w-[1240px]'>
            <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
                ...
                <button className='bg-[#00df9a] text-[#000300] w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3'>Start Trial</button>
            </div>
            <div className='w-full shadow-xl flex flex-col p-4 md:my-0 my-8 bg-gray-100  rounded-lg hover:scale-105 duration-300'>
                ...
                <button className='bg-[#000300] text-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3'>Start Trial</button>
            </div>
            <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
